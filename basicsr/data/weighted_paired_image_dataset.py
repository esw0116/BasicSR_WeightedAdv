...
class WeightPairedImageDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            # flip, rotation
            img_gt, img_lq, img_coeff = augment([img_gt, img_lq, img_coeff], self.opt['use_hflip'], self.opt['use_rot'])
        ...
        if self.opt['phase'] != 'train':
            ...
            img_coeff = img_coeff[0:img_lq.shape[0] * scale, 0:img_lq.shape[1] * scale, :]

        # BGR to RGB, HWC to CHW, numpy to tensor
        img_gt, img_lq, img_coeff= img2tensor([img_gt, img_lq, img_coeff], bgr2rgb=True, float32=True)
        # normalize
