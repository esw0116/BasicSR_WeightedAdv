...
class PyWeightPairedImageDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(PyWeightPairedImageDataset, self).__init__()
        self.opt = opt
        ...
        if self.io_backend_opt['type'] == 'lmdb':
            ...
            self.paths = pyweighted_paired_paths_from_folder([self.lq_folder, self.gt_folder, self.weight_folder], 
