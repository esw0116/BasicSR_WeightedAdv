...
class HybridPairedImageDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(HybridPairedImageDataset, self).__init__()
        self.opt = opt
        ...
        if self.io_backend_opt['type'] == 'lmdb':
            ...
            for i in range(len(self.gt_folder)):
                self.paths.extend(paired_paths_from_folder([self.lq_folder[i], self.gt_folder[i]], 
                                                             ['lq', 'gt'], self.filename_tmpl[i]))
