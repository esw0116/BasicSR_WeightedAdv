...
from data.transforms import pyaugment, paired_random_crop
from utils import FileClient, bgr2ycbcr, imfrombytes, img2tensor
from utils.registry import DATASET_REGISTRY


@DATASET_REGISTRY.register()
class PyPairedImageDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(PyPairedImageDataset, self).__init__()
        self.opt = opt
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            # flip, rotation
            img_gt, img_lq = pyaugment([img_gt, img_lq], self.opt['use_hflip'], self.opt['use_rot'])
